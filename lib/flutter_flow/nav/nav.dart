        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: Screen3Widget.routePath,
              builder: (context, params) => Screen3Widget(
                paypalPayMeLink: params.getParam(
                  'paypalPayMeLink',
                  ParamType.String,
                ),
                uid: params.getParam(
            ...
            FFRoute(
              ...
              path: AvailableRidesScreenWidget.routePath,
              builder: (context, params) => AvailableRidesScreenWidget(
                selectedRideId: params.getParam(
                  'selectedRideId',
                  ParamType.int,
                ),
              ),
            ...
            FFRoute(
              name: RideDetailsScreenWidget.routeName,
              path: RideDetailsScreenWidget.routePath,
              builder: (context, params) => RideDetailsScreenWidget(
                selectedRide: params.getParam(
                  'selectedRide',
            ...
            FFRoute(
              ...
              builder: (context, params) => AdminPageWidget(
                getdata: params.getParam(
                  'getdata',
                  ParamType.SupabaseRow,
                  isList: true,
                ),
                getdata2: params.getParam(
                  'getdata2',
                  ParamType.SupabaseRow,
                ),
              ),
